...
// he Interface Definition Language (IDL) is a language for specifying operations (procedures or functions),
// parameters to these operations, and data types.
...
const (
	RecommendationMode_GetFarthest RecommendationMode = 0 // tag of enum starts from 0
...
type Point struct {
	...
	Latitude  int32 `protobuf:"varint,1,opt,name=latitude,proto3" json:"latitude,omitempty"` // tag starting from 1
...
var file_route_proto_rawDesc = []byte{
	...
	0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x71, 0x75, 0x6d, 0x69, 0x6e, 0x7a, 0x68, 0x69, 0x2f, 0x67, 0x72,
	0x70, 0x63, 0x2d, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x2f, 0x72, 0x6f, 0x75, 0x74, 0x65,
